<?php
    ...
    switch ( $url )
    {
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="#">Générateur Cercle</a></li>
                                    <li><a class="dropdown-item" href="#">Générateur Sphère</a></li>
                                </ul>
                                <!-- Dropdown Pokémon -->
                                <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="#">Coverage</a></li>
        ...
        case "http://127.0.0.1/Site-Perso/Minecraft/" :
            ...
            <?php
        break;
        case "http://127.0.0.1/Site-Perso/Pokemon/" :
            ?>
            
            <?php
        break;
        case "http://127.0.0.1/Site-Perso/Sky/" :
            ?>
