...
?>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="Pokemon">Pokémon</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="Sky">Sky</a>
    ...
    //Si dans jeu : 
    //case "C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\Site-Perso\Minecraft" : 
    default :
