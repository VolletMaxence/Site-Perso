    ...
    <body>
        ...
        //Obtenir tout les livres en base
            ...
            <form method="post" id="nbrTomeForm" required style="visibility: hidden;">
                ...
                <div>
                    <input id="nbrTomeSubmit" name="EnvoieDansBase" type=button onclick="UpdateBDD( <?= $_SESSION['IDusername'] ?>)" class="btn btn-default" value="Ajout du livre en base" required style="visibility: hidden;">
                </div>
    </body>
